#!/usr/bin/env python3
"""Create comprehensive visualizations with Winkler score"""
...
ax.set_title('Coverage Comparison Across All Datasets', fontsize=14, fontweight='bold')
...
# ===========================================================================
# 2. Winkler Score Comparison (NEW!)
# ===========================================================================
...
ax.set_title('Winkler Score Comparison Across All Datasets', fontsize=14, fontweight='bold')
ax.set_xticks(x + width)
ax.set_xticklabels(methods)
ax.legend()
ax.grid(True, alpha=0.3, axis='y')
...
ax.set_title('Coverage vs Winkler Score Trade-off', fontsize=14, fontweight='bold')
...
for idx, model in enumerate(models):
    ...
    for i, method in enumerate(methods):
        ...
        # Normalize Coverage by 0.9 (target), Width and Winkler by their max across methods
...
with open('results/summary.md', 'w') as f:
    f.write("# Conformal Prediction Experiments - Complete Results\n\n")
    f.write(f"**Total experiments:** 45/45 ✓\n\n")
    ...
    f.write("- **Parametric methods** achieve best coverage (91.9%) but wider intervals\n")
    f.write("- **Conformal methods** balance coverage (72.9%) with moderate intervals\n")
    f.write("- **Bootstrap methods** produce narrow intervals but severe under-coverage (22.2%)\n")
    f.write("- **Winkler score** shows parametric and conformal methods perform better overall\n")
    f.write("- **LSTM + Conformal** (properly implemented with residuals) shows good balance\n")
    f.write("- **Heavy-tailed data** handled well by all parametric methods\n")
    f.write("- **GARCH data** remains challenging across all methods\n")
